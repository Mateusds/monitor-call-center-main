...
interface ChatMonthFilterProps {
    onFilterChange: (startDate: string, endDate: string) => void;
    currentPeriod: string;
}

export function ChatMonthFilter({ onFilterChange, currentPeriod }: ChatMonthFilterProps) {
    const [selectedMonth, setSelectedMonth] = useState<string>('');

    // Meses disponíveis para Chat (sem Outubro/2025)
